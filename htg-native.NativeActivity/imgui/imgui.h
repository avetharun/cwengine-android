...
namespace ImGui
{
    ...
    IMGUI_API bool          InputDouble2(const char* label, double v[2], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputDouble3(const char* label, double v[3], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputDouble4(const char* label, double v[4], ImGuiInputTextFlags flags = 0);
...
namespace ImGui {
    struct ImRGB {
        ...
        unsigned char getb();
        unsigned char geta();
        ImTriple<int,int,int> convertHSV();
