...
#define LOGV(...) ((void)__android_log_print(ANDROID_LOG_VERBOSE, ndk_helper::JNIHelper::GetInstance()->GetAppName(), __VA_ARGS__))
...
#define LOGF(...) ((void)__android_log_print(ANDROID_LOG_FATAL, ndk_helper::JNIHelper::GetInstance()->GetAppName(), __VA_ARGS__))
#define LOGD(...) ((void)__android_log_print(ANDROID_LOG_DEBUG, ndk_helper::JNIHelper::GetInstance()->GetAppName(), __VA_ARGS__))
